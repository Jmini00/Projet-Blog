...
// Selectionne toutes les categories liees à l'article
$query = $bdd->prepare("SELECT category_id FROM articles_categories WHERE article_id = :id");
$query->bindValue(':id', $articleId);
$query->execute();

// POD::FETCH_COLUMN
// Retourne un tableau indexé contenant les valeurs extraites de
// la requete SQL pour une seule colonne
